...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t ARCoreFaceRegionData_get_region_m7CD0AB1C423FD7A964F41C4CCCD14857C08177FE (ARCoreFaceRegionData_tC5ABC889AB00A0DB777FFB44FD943E772F8A4F11* __this, const RuntimeMethod* method) ;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971 ARCoreFaceRegionData_get_pose_m8B0A57A837D75EC314AE73F2931075A0F10A3775 (ARCoreFaceRegionData_tC5ABC889AB00A0DB777FFB44FD943E772F8A4F11* __this, const RuntimeMethod* method) ;
...
IL_001d:
	...
	}
	{
		...
		MaterialU5BU5D_t2B1D11C42DB07A4400C0535F92DBB87A2E346D3D* L_5 = __this->____materials_4;
		NullCheck(L_5);
		__this->___index_6 = ((int32_t)(((int32_t)il2cpp_codegen_add(L_4, 1))%((int32_t)(((RuntimeArray*)L_5)->max_length))));
		// foreach (ARFace face in _faceManager.trackables)
		ARFaceManager_tE5955187C9D7C9C4C4139F522DA0DEA69EFCFD8F* L_6 = __this->____faceManager_5;
		NullCheck(L_6);
		TrackableCollection_1_t7F8F18DAEBAC38B9CA739A30AD2C21CCE8F8B305 L_7;
		L_7 = ARTrackableManager_5_get_trackables_m32440CFD7C68D75BB3FB2ED84A6DEE060390FBD7(L_6, ARTrackableManager_5_get_trackables_m32440CFD7C68D75BB3FB2ED84A6DEE060390FBD7_RuntimeMethod_var);
		V_3 = L_7;
		Enumerator_t2743D5A35F15690DAB1B61F0480A44C6AFE6C2DC L_8;
		L_8 = TrackableCollection_1_GetEnumerator_m3CD3F46003D1DE39B7C8FFD1490E59DD23BEBA3F((&V_3), TrackableCollection_1_GetEnumerator_m3CD3F46003D1DE39B7C8FFD1490E59DD23BEBA3F_RuntimeMethod_var);
		V_2 = L_8;
		goto IL_0075;
	}
...
IL_0050:
	{
		...
		L_9 = Enumerator_get_Current_mB4CF0F77C9B33C52C2A790C2E568FAF17AB70F19((&V_2), Enumerator_get_Current_mB4CF0F77C9B33C52C2A790C2E568FAF17AB70F19_RuntimeMethod_var);
		V_4 = L_9;
		// face.GetComponent<MeshRenderer>().material = _materials[index];
		ARFace_t73C068C9C8422F79A858EC41C322D399305B8453* L_10 = V_4;
		NullCheck(L_10);
		...
		MaterialU5BU5D_t2B1D11C42DB07A4400C0535F92DBB87A2E346D3D* L_12 = __this->____materials_4;
...
IL_0075:
	{
		// foreach (ARFace face in _faceManager.trackables)
		bool L_16;
		L_16 = Enumerator_MoveNext_mBE785620F02FA4C9BFF31CC4A56D796BCA196F04((&V_2), Enumerator_MoveNext_mBE785620F02FA4C9BFF31CC4A56D796BCA196F04_RuntimeMethod_var);
		if (L_16)
		{
			goto IL_0050;
		}
...
IL_0059_1:
			{
				...
				int32_t L_13;
				L_13 = ARCoreFaceRegionData_get_region_m7CD0AB1C423FD7A964F41C4CCCD14857C08177FE((&V_5), NULL);
				V_6 = L_13;
				...
				L_19 = ARCoreFaceRegionData_get_pose_m8B0A57A837D75EC314AE73F2931075A0F10A3775((&V_5), NULL);
				...
				L_26 = ARCoreFaceRegionData_get_pose_m8B0A57A837D75EC314AE73F2931075A0F10A3775((&V_5), NULL);
...
IL_0038:
	...
	}
	{
		...
		Color32U5BU5D_t38116C3E91765C4C5726CE12C77FAD7F9F737259* L_14 = __this->___colors_5;
		MaterialU5BU5D_t2B1D11C42DB07A4400C0535F92DBB87A2E346D3D* L_15 = __this->____carMats_7;
		NullCheck(L_15);
		int32_t L_16 = 0;
		...
		NullCheck(L_14);
		(L_14)->SetAt(static_cast<il2cpp_array_size_t>(0), (Color32_t73C5004937BF5BB8AD55323D51AAA40A898EF48B)L_19);
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CarController_Update_mA0FE1C8A651320D6A50CC5BF05D0D2BEE984AB67 (CarController_t040DDF82A09770A77B8C41CDB423E13FE6F68CD5* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Ray__ctor_mE298992FD10A3894C38373198385F345C58BD64C((&V_3), L_7, L_10, NULL);
		// if (Physics.Raycast(ray, out hitInfo, Mathf.Infinity, 1<<6))
		Ray_t2B1742D7958DC05BDC3EFC7461D3593E1430DC00 L_11 = V_3;
		bool L_12;
		L_12 = Physics_Raycast_m34AC1210E893A9EF969BD2C7104B10BE5B580025(L_11, (&V_4), (std::numeric_limits<float>::infinity()), ((int32_t)64), NULL);
		V_5 = L_12;
		bool L_13 = V_5;
		if (!L_13)
		{
	...
	}
	{
		...
		float L_21 = __this->___rotSpeed_6;
		NullCheck(L_16);
		Transform_Rotate_m35B44707FE16FF8015D519D8C162C0B4A85D6D1F(L_16, L_18, ((float)il2cpp_codegen_multiply(((float)il2cpp_codegen_multiply(L_20, (-1.0f))), L_21)), NULL);
	}
...
IL_0021:
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_4 = __this->___indicator_4;
		NullCheck(L_4);
		bool L_5;
...
IL_0039:
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_11 = __this->____placedGameObject_8;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_12;
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_14 = __this->___car_5;
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_15 = __this->___indicator_4;
		NullCheck(L_15);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_16;
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_18 = __this->___indicator_4;
		NullCheck(L_18);
		...
		__this->____placedGameObject_8 = L_21;
		Il2CppCodeGenWriteBarrier((void**)(&__this->____placedGameObject_8), (void*)L_21);
		goto IL_0109;
	}
...
IL_00a1:
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_22 = __this->____placedGameObject_8;
		NullCheck(L_22);
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_25 = __this->___indicator_4;
		NullCheck(L_25);
		...
		float L_29 = __this->___relocationDistance_6;
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_31 = __this->____placedGameObject_8;
		NullCheck(L_31);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_32;
		L_32 = GameObject_get_transform_m0BC10ADFA1632166AE5544BDF9038A2650C2AE56(L_31, NULL);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_33 = __this->___indicator_4;
		NullCheck(L_33);
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_36 = __this->___indicator_4;
		NullCheck(L_36);
		...
		NullCheck(L_32);
		Transform_SetPositionAndRotation_m418859BF59086EEAA084FFD6F258A43FAB408F5A(L_32, L_35, L_38, NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CarManager_DetectGround_m366C5C4DFACF71CE70D7984BAC9A346F5AC89191 (CarManager_t0D317F63D7063875A11CEE484332D47D211547E9* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_9 = __this->___indicator_4;
		NullCheck(L_9);
...
IL_00cd:
	{
		// indicator.SetActive(false);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_30 = __this->___indicator_4;
		NullCheck(L_30);
